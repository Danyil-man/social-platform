...
export const LogInForm: FC<InjectedFormProps<LoginFormValuesType, LoginFormProps> & LoginFormProps> = (props) => {
  return (
...
const ReduxForm = reduxForm<LoginFormValuesType, LoginFormProps>({
  form: "login",
})(LogInForm);
